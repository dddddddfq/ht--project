<template>
	<div>
		<el-row :gutter="15" style="margin-top:-10px">
			<el-col :span="6"><span><el-card><Detail title="总销售额" cont="$253621" footer="日销售额 $2312">
				<template slot="chars">
					<div>
					周同比  52.24%<svg t="1652869842829" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5607" width="20" height="20"><path d="M512 405.333333L298.666667 618.666667h426.666666L512 405.333333z" fill="#d81e06" p-id="5608"></path></svg>
					  日同比  17.23%<svg t="1652869892561" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7213" width="20" height="20"><path d="M512 618.666667L298.666667 405.333333h426.666666L512 618.666667z" fill="#1afa29" p-id="7214"></path></svg>
					</div>
				</template>
				...
				</Detail></el-card></span></el-col>
			<el-col :span="6"><span><el-card><Detail title="访问量" cont="88541" footer="日访问量 2422">	
				<template slot="footer">
					<div>
					  日访问量  1542
					</div>
			...
			<el-col :span="6"><span><el-card><Detail title="支付笔数" cont="20145" footer="转化率  20%">
					<template slot="footer">
					<div>
					 转化率  65%
					</div>
			...
			<el-col :span="6"><span><el-card><Detail title="运营活动效果" cont="78%" style="overflow: hidden;">
					<template slot="chars">
						<prograss/>
					</template>
					<template slot="footer">
...
import prograss from './prograss/index.vue';
export default {
	name: "Card",
	components: {
		Detail,
		lineCharts,barCharts,prograss
	},
};
</script>
